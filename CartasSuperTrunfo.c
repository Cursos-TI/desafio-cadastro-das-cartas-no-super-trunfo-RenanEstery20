...
int main() {
    ...
    scanf("%u", &populacao1); // %u para unsigned int
    ...
    // Comparação direta (Aventureiro): imprime 1 se carta 1 venceu, 0 se não venceu
    ...
    // Para o nível aventureiro, não precisa do super poder!
}
